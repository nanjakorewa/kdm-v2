---
title: Pemulusan Eksponensial Sederhana
weight: 1
pre: "<b>5.2.1 </b>"
---
...
## Data Sampel
Data yang digunakan adalah [Natural Gas Consumption (NATURALGAS)](https://fred.stlouisfed.org/series/NATURALGAS). Satuan angka adalah BCF (miliar kaki kubik).
...
## Pembagian Data
Data akan dibagi, di mana data bagian akhir (data setelah tahun 2020) akan digunakan untuk memverifikasi kinerja prediksi.
