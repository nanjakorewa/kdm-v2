---
title: Holt's Linear Exponential Smoothing Method
weight: 2
pre: "<b>5.2.2 </b>"
---
...
## Sample Data
The data used is from [Natural Gas Consumption (NATURALGAS)](https://fred.stlouisfed.org/series/NATURALGAS). The unit of measurement is BCF (billion cubic feet).
...
![png](/images/timeseries/exponential_smoothing/002-hw-es_files/002-hw-es_4_0.png)
    

## Data Splitting
The dataset is split so that the data from the end (data from 2020 onwards) is used for validating the forecasting performance.
...
![png](/images/timeseries/exponential_smoothing/002-hw-es_files/002-hw-es_6_0.png)
...
![png](/images/timeseries/exponential_smoothing/002-hw-es_files/002-hw-es_9_0.png)
